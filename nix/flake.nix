  ...
  # Generate outputs for all default systems (x86_64-linux, aarch64-linux, x86_64-darwin, aarch64-darwin)
    flake-utils.lib.eachDefaultSystem (
      system: let
        ...
        worker = mkRustPackage "worker"; # Worker / main orchestrator binary
      ...
      in {
        ...
        nixosModules = {
          ...
          # NixOS guest module (usually consumed by mkVmImage, not directly)
          guest = import ./lib/image/vm-module.nix;
        };

        # Library functions: reusable Nix functions for VM management
        ...
        lib = import ./lib { inherit pkgs nixpkgs system; };
