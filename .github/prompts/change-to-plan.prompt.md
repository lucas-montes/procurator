---
description: Turn a change request into a scoped SCE plan via the sce-plan-authoring skill.
agent: shared-context-plan
---

Load and follow the [`sce-plan-authoring`](../skills/sce-plan-authoring/SKILL.md) skill.

Input change request:
${input:request:Describe the change you want to plan}

## Behavior
- Keep this prompt as thin orchestration; detailed clarification handling, plan-shape rules, and task-writing behavior stay owned by the skill.
